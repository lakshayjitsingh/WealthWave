      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', textAlign: 'left', height: '100%' }}>
        ...
        {!window.navigator.userAgent.includes('Electron') && (
          <div style={{ marginBottom: '2.5rem' }}>
            <a href="https://drive.google.com/file/d/1llGJNQQouuR9bhyNfMeLd_wzqetAEsU3/view?usp=sharing" target="_blank" rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
              <div style={{ 
